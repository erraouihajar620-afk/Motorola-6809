    ...
    public static ArrayList<String> parseInstruction(String instruction) {
        ...
        if (parts.length == 2) {
        	...
        	else if(parts[1].contains(","))
            {
					...
					{
						dep = clsAdressingModes.deplacement.nul_inc_dec;
						if(parts[1].substring(1).equals(",X"))
						stValue = "85";
					else if(parts[1].substring(1).equals(",Y"))
						stValue = "A5";
					else if(parts[1].substring(1).equals(",U"))
						stValue = "C5";
					else if(parts[1].substring(1).equals(",S"))
						stValue = "E5";
					}
					else if(parts[1].startsWith("PC"))
					{
